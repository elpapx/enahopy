...
class ENAHOConfig:
    ...
    base_url: str = field(default_factory=lambda: os.getenv("ENAHO_BASE_URL",
    ...
    default_max_workers: int = field(default_factory=lambda: int(os.getenv("ENAHO_MAX_WORKERS", "4")))
    ...
    backoff_factor: float = field(default_factory=lambda: float(os.getenv("ENAHO_BACKOFF_FACTOR", "0.5")))

    # Configuración de lectura local
    chunk_size_default: int = field(default_factory=lambda: int(os.getenv("ENAHO_READ_CHUNK_SIZE", "10000")))
    ...
    YEAR_MAP_TRANSVERSAL: Dict[str, int] = field(default_factory=lambda: {
        "2023": 906, "2022": 784, "2021": 759, "2020": 737, "2019": 687,
        "2018": 634, "2017": 603, "2016": 546, "2015": 498, "2014": 440,
        "2013": 404, "2012": 324, "2011": 291, "2010": 279, "2009": 285,
        "2008": 284, "2007": 283, "2006": 282, "2005": 281, "2004": 280,
        "2003": 279, "2002": 278, "2001": 277  # Años adicionales
    })

    YEAR_MAP_PANEL: Dict[str, int] = field(default_factory=lambda: {
        "2023": 912, "2022": 845, "2021": 763, "2020": 743, "2019": 699,
        "2018": 651, "2017": 612, "2016": 614, "2015": 529, "2011": 302,
    })

    # Módulos disponibles con descripciones
    AVAILABLE_MODULES: Dict[str, str] = field(default_factory=lambda: {
