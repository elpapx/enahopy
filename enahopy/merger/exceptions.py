...
class ModuleValidationError(ENAHOValidationError):
    ...
    def __init__(self, message: str, module_code: str = None,
                 validation_failures: list = None, **context):
        super().__init__(message)
...
class IncompatibleModulesError(ModuleMergeError):
    ...
    def __init__(self, message: str, module1: str = None, module2: str = None,
                 compatibility_info: dict = None, **context):
        super().__init__(message)
...
class MergeKeyError(ModuleMergeError):
    ...
    def __init__(self, message: str, missing_keys: list = None,
                 invalid_keys: list = None, **context):
        super().__init__(message)
...
class ConflictResolutionError(ModuleMergeError):
    ...
    def __init__(self, message: str, conflicts: list = None,
                 strategy_used: str = None, **context):
        super().__init__(message)
...
class ValidationThresholdError(ENAHOValidationError):
    ...
    def __init__(self, message: str, threshold_type: str = None,
                 expected: float = None, actual: float = None, **context):
        super().__init__(message)
...
class ConfigurationError(ENAHOError):
    ...
    def __init__(self, message: str, config_section: str = None,
                 invalid_values: dict = None, **context):
        super().__init__(message)
